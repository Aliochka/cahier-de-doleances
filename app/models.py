...
class Contribution(Base):
    ...
    form_id: Mapped[int] = mapped_column(ForeignKey("forms.id"))
    source: Mapped[str | None] = mapped_column(String)
    theme_id: Mapped[int | None] = mapped_column(Integer)  # obsolète si topics, conservé pour compat
...
class ContributionTopic(Base):
    ...
    contribution_id: Mapped[int] = mapped_column(ForeignKey("contributions.id"), primary_key=True)
